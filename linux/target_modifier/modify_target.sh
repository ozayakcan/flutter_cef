...
bash $scriptdir/tools/import_flutter_cef_header_my_application.sh "$program_path/linux/my_application.cc"
...
bash $scriptdir/tools/import_flutter_cef_header_main.sh "$program_path/linux/main.cc"
