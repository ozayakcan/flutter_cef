...
typedef struct _FlutterCefPlugin FlutterCefPlugin;
typedef struct {
  GObjectClass parent_class;
} FlutterCefPluginClass;

FLUTTER_PLUGIN_EXPORT GType flutter_cef_plugin_get_type();

FLUTTER_PLUGIN_EXPORT void flutter_cef_plugin_register_with_registrar(
